# -*- encoding: utf-8 -*-
# stub: jekyll-cloudinary 1.11.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.date = "2018-05-21"
  s.description = "    Liquid tag to use Cloudinary for optimized responsive posts images.\n".freeze
  s.email = ["nicolas@hoizey.com".freeze]
  s.homepage = "https://nhoizey.github.io/jekyll-cloudinary/".freeze
  s.licenses = ["MIT".freeze]
  s.rubygems_version = "2.7.6".freeze
  s.summary = "Liquid tag for Jekyll with Cloudinary".freeze
